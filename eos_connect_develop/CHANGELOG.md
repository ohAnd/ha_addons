...
**Version 0.3.34.289** published on 2026-04-09
- fix: preserve PV installations in the config UI after migration (#243)
...
**Version 0.3.34.285** published on 2026-04-06
- feat: section reordering and cross-field dependency system in the web configuration UI
...
- docs: create new GitHub Pages documentation with detailed configuration reference -> https://ohand.github.io/EOS_connect/
